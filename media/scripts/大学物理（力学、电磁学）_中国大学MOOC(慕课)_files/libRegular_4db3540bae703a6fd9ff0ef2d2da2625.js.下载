    ...
    return (function(t) {
        ...
        function(t, e, n) {
            var r = n(1),
                ...
                o = a.Parser,
                s = a.Lexer;
            r.browser && (n(6), n(7), n(8), (a.dom = n(4))),
                (a.env = r),
                (a.util = n(5)),
                (a.parse = function(t, e) {
                    (e = e || {}),
                        (e.BEGIN || e.END) &&
                            (e.BEGIN && (i.BEGIN = e.BEGIN),
                            e.END && (i.END = e.END),
                            s.setup());
                    var n = new o(t).parse();
        ...
        function(t, e, n) {
            ...
            (e.svg = (function() {
                ...
                (e.browser =
                    'undefined' != typeof document && document.nodeType),
                (e.exprCache = r.cache(1e3)),
                (e.isRunning = !1);
        },
        function(t) {
            ...
            var d = n(16),
                ...
                y = function(t, e) {
                    ...
                    (e = e || {}),
                        ...
                        this.data && s.extend(t.data, this.data),
                        this.computed && s.extend(t.computed, this.computed);
                    var f,
                        l = this._eventListeners || [];
                    t.events &&
                        ((f = s.normListener(t.events)),
                        f.length && (l = l.concat(f)),
                        delete t.events),
                        s.extend(this, t, !0),
                        ...
                        'string' == typeof o &&
                            ...
                            (i = h.find(o)) &&
                            (o = i.innerHTML),
                        o && o.nodeType && (o = o.innerHTML),
                        'string' == typeof o &&
                            ((o = new a(o).parse()),
                            u
                                ? (this.constructor.prototype.template = o)
                                : delete this.template),
                        (this.computed = x(this.computed)),
                    ...
                    (this._body = null),
                        p &&
                            p.ast &&
                            p.ast.length &&
                            (this.$body = s.getCompileFn(p.ast, p.ctx, {
                                outer: this,
                        ...
                        this.$emit('$afterInit'),
                        (r.isRunning = n),
                        this.devtools && this.devtools.emit('init', this);
                },
                E = window.__REGULAR_DEVTOOLS_GLOBAL_HOOK__;
            E && (y.prototype.devtools = E),
                f && (f.Regular = y),
                s.extend(y, {
                    ...
                    __after__: function(t, e) {
                        ...
                        if (
                            ...
                            e.name && y.component(e.name, this),
                            (n = e.template))
                        ) {
                            var r, i;
                            'string' == typeof n &&
                                ...
                                n &&
                                    ...
                                    (n = n.innerHTML)),
                                'string' == typeof n &&
                                    (this.prototype.template = o.PRECOMPILE
                                        ? new a(n).parse()
                                        : n);
                        }
                        e.computed && (this.prototype.computed = x(e.computed)),
                            y._inheritConfig(this, t);
                    },
                    directive: function(t, e) {
                        ...
                        if (null == e) {
                            ...
                            for (
                                var o = a.__regexp__, u = 0, c = o.length;
                                c > u;
                                u++
                            ) {
                                r = o[u];
                        ...
                        return (
                            'function' == typeof e && (e = { link: e }),
                            'string' === i
                                ? (a[t] = e)
                                : 'regexp' === i &&
                                  ((e.regexp = t), a.__regexp__.push(e)),
                            this
                        );
                    },
                    plugin: function(t, e) {
                    ...
                    use: function(t) {
                        return (
                            'string' == typeof t && (t = y.plugin(t)),
                            'function' != typeof t ? this : (t(this, y), this)
                        );
                    },
                    config: function(t) {
                        var e = !1;
                ...
                u(y),
                y._addProtoInheritCache('component'),
                y._addProtoInheritCache('filter', function(t) {
                ...
                y.implement({
                    ...
                    $compile: function(t, e) {
                        (e = e || {}),
                            'string' == typeof t && (t = new a(t).parse());
                        var n,
                            r = this.__ext__,
                            i = e.record;
                        e.extra && (this.__ext__ = e.extra),
                            i && this._record();
                    ...
                    _walk: function(t, e) {
                        ...
                        return 'string' == typeof t
                            ? p.createTextNode(t)
                            : f[t.type || 'default'].call(this, t, e);
                    },
                    _append: function(t) {
                    ...
                    _handleEvent: function(t, e, n, r) {
                        var i,
                            ...
                            o =
                                'function' != typeof n
                                    ? s.handleEvent.call(this, n, e)
                                    : n,
                            u = a.event(e);
                        return (
                            u ? (i = u.call(this, t, o, r)) : h.on(t, e, o),
                            u
                                ? i
                                : function() {
                                      h.off(t, e, o);
                    ...
                    _sg_: function(t, e, n) {
                        ...
                        return 'undefined' == typeof e ||
                            'undefined' == typeof t
                            ? void 0
                            : n && 'undefined' != typeof n[t] ? n[t] : e[t];
                    },
                    _ss_: function(t, e, n, r, i) {
                        ...
                        if (o) {
                            ...
                            s.log(
                                "the computed '" +
                                    t +
                                    "' don't define the set function,  assign data." +
                                    t +
                                    ' altnately',
                                'warn'
                            );
                ...
                (y.prototype.inject = function() {
                    return (
                        s.log('use $inject instead of inject', 'error'),
        ...
        function(t, e, n) {
            ...
            function a(t) {
                ...
                if (
                    m.test(e) &&
                    ((this.pageX =
                        null != t.pageX ? t.pageX : t.clientX + g.scrollLeft),
                    (this.pageY =
                        null != t.pageX ? t.pageY : t.clientY + g.scrollTop),
                    'mouseover' === e || 'mouseout' === e)
                ) {
                    for (
                        var r =
                            t.relatedTarget ||
                            t[('mouseover' === e ? 'from' : 'to') + 'Element'];
                        r && 3 === r.nodeType;
                ...
                ('DOMMouseScroll' === e || 'mousewheel' === e) &&
                    (this.wheelDelta = t.wheelDelta
                        ? t.wheelDelta / 120
                        : -(t.detail || 0) / 3),
                    (this.which = t.which || t.keyCode),
                    this.which ||
                        void 0 === n ||
                        (this.which = 1 & n ? 1 : 2 & n ? 3 : 4 & n ? 2 : 0),
                    (this._fixed = !0);
            }
            var o,
                s,
            ...
            (u.body = document.body),
                ...
                (u.msie = parseInt(
                    (/msie (\d+)/.exec(navigator.userAgent.toLowerCase()) ||
                        [])[1]
                )),
                isNaN(u.msie) &&
                    (u.msie = parseInt(
            ...
            var v = {
                class: function(t, e) {
                    'className' in t &&
                    (!t.namespaceURI || t.namespaceURI === d.html)
                        ? (t.className = e || '')
            ...
            (u.attr = function(t, e, n) {
                if (h.isBooleanAttr(e)) {
                    if ('undefined' == typeof n)
                        return t[e] ||
                            (t.attributes.getNamedItem(e) || p).specified
                            ? e
                            : void 0;
                    n
                        ? ((t[e] = !0),
                ...
                (u.css = function(t, e, n) {
                    if ('object' !== h.typeOf(e)) {
                        ...
                        for (var a in e)
                            e.hasOwnProperty(a) && u.css(t, a, e[a]);
                }),
            ...
            var m = /^(?:click|dblclick|contextmenu|DOMMouseScroll|mouse(?:\w+))$/,
                g = document;
            (g =
                g.compatMode && 'CSS1Compat' !== g.compatMode
                    ? g.body
                    : g.documentElement),
                ...
                (i.camelCase = function(t) {
                    ...
                    (i.normListener = function(t) {
                        ...
                        if ('object' === n)
                            for (var r in t)
                                t.hasOwnProperty(r) &&
                                    e.push({ type: r, listener: t[r] });
                        return e;
                    }),
                    (i.isVoidTag = i.makePredicate(
                        'area base br col embed hr img input keygen link menuitem meta param source track wbr r-content'
                    )),
                    (i.isBooleanAttr = i.makePredicate(
                        'selected checked disabled readonly required open autofocus controls autoplay compact loop defer multiple'
                    )),
                    (i.isExpr = function(t) {
            ...
            n(23),
                ...
                (t.exports = {
                    ...
                    ref: {
                        ...
                        link: function(t, e) {
                            var n,
                                i = this.$refs || (this.$refs = {});
                            return (
                                r.isExpr(e)
                                    ? this.$watch(e, function(e, r) {
                                          (n = e),
                                              i[r] === t && (i[r] = null),
                                              n && (i[n] = t);
                                      })
        ...
        function(t, e, n) {
                        ...
                        if (l !== c)
                            if (l !== h) {
                                ...
                                if (!v || !f)
                                    throw Error(
                                        v
                                            ? 'you should start with `on` or `event` in animation'
                                            : 'undefined animator 【' + l + '】'
                                    );
                                f.push(
                                    v.call(this, {
                                        element: t,
            ...
            var a = n(5),
                ...
                c = 'when',
                h = 'on';
            s._addProtoInheritCache('animation'),
                s.animation({
                    wait: function(t) {
                    ...
                    emit: function(t) {
                        ...
                        if (!r)
                            throw Error(
                                'you shoud specified a eventname in emit command'
                            );
                        var a = this;
                        return function(t) {
                        ...
                        return (
                            i.forEach(function(t) {
                                if ((t = t.trim())) {
                                    ...
                                    if (!i || !a)
                                        throw Error(
                                            'invalid style in command: style'
                                        );
                                    (n[i] = a), (e = !0);
                                }
                            }),
                ...
                s.directive('r-animation', i),
                s.directive('r-anim', i);
        },
        function(t, e, n) {
            function r(t) {
                t.implement({
        ...
        function(t, e, n) {
            ...
            (f.list = function(t, e) {
                ...
                function i(n, r, i, a) {
                    for (var u = n; r > u; u++) {
                        ...
                        d.parentNode && s.inject(o.node(p), d, 'after'),
                            T.children.splice(u + 1, 0, p);
                    }
                }
                function c(t, e, n, r) {
                    (t[N] = e),
                    ...
                    if (
                        ...
                        for (var c = 0; c < r.length; c++) {
                            var h = r[c],
                                ...
                                v = p.length;
                            if (A && v && d) {
                                for (var g = Math.min(v, d), y = 0; g > y; )
                                    m(t[f], f) !== m(p[0], f) &&
                                        (n(f, 1), i(f, f + 1, t, o)),
                                        p.shift(),
                                        d--,
                ...
                function v(t, n, i) {
                    ...
                    if (
                        ...
                        T.children.push(N),
                            y.parentNode && s.inject(o.node(N), y, 'after');
                    }
                }
                var m,
                    g,
                    y = (f.Regular, document.createComment('Regular list')),
                    E = e.namespace,
                    x = e.extra,
                    _ = this,
                    T = new u([y]),
            ...
            (f['if'] = function(t, e) {
                ...
                var n,
                    r,
                    h = document.createComment('Regular if' + l++),
                    f = new u();
                f.push(h);
                var p = null,
                    d = e.namespace,
                    c = function(u) {
                        ...
                        c !== p &&
                            ((p = c),
                            f.children[1] &&
                                (f.children[1].destroy(!0), f.children.pop()),
                            c
                                ? t.consequent &&
                                  t.consequent.length &&
                                  ((n = i.$compile(t.consequent, {
            ...
            (f.element = function(t, e) {
                ...
                if ('r-content' === v)
                    return (
                        h.log(
                            'r-content is deprecated, use {#inc this.$body} instead (`{#include}` as same)',
                            'warn'
                        ),
                        this.$body && this.$body()
                    );
                if (m || 'r-component' === v)
                    return (e.Component = m), f.component.call(this, t, e);
                'svg' === v && (p = 'svg'),
                    l &&
                        l.length &&
                        (n = this.$compile(l, {
                    ...
                    (r = c.create(v, p, a)),
                    n && !h.isVoidTag(v) && c.inject(o.node(n), r),
                    h.fixTagAST(t, u);
                ...
                return {
                    ...
                    destroy: function(t) {
                        t
                            ? s.remove(r, n ? n.destroy.bind(n) : h.noop)
                            : n && n.destroy(),
                            g.length &&
                ...
                (f.component = function(t, e) {
                    for (
                        ...
                        var E = s[g],
                            x = this._touchExpr(
                                void 0 === E.value ? !0 : E.value
                            );
                        x.constant && (x = E.value = x.get(this)),
                            E.value &&
                                E.value.constant === !0 &&
                                (x = x.get(this));
                        var _ = E.name;
                        ...
                        if (
                            ...
                            i = x;
                            var N = this.$get(x, !0);
                            if (((c = f.component(N)), 'function' != typeof c))
                                throw new Error(
                                    'component ' + N + ' has not registed!'
                                );
                        }
                        var w;
                        (w = E.event)
                            ? ((a = a || {}),
                              (a[w] = h.handleEvent.call(this, x, w)))
                            : ((_ = E.name = h.camelCase(_)),
                              (m[_] =
                                  x && 'expression' === x.type ? x.get(v) : x),
                              'ref' === _ && null != x && (r = x),
                              'isolate' === _ &&
                                  ((n =
                                      'expression' === x.type
                    ...
                    var b,
                        ...
                        e = { namespace: d, extra: e.extra },
                        A = new c($, e);
                    r &&
                        this.$refs &&
                        ((b = c.directive('ref').link),
                        this.$on('$destroy', b.call(this, A, r))),
                        r && v.$refs && (v.$refs[r] = A);
                ...
                (f.attribute = function(t, e) {
                    ...
                    if (
                        ...
                        var l = {
                                attrs: e.attrs,
                                param: h.getParamObj(this, n.param),
                            },
                            p = s.link.call(f, u, i, r, l);
                        return (
                            'function' == typeof s.update &&
                                (h.isExpr(i)
                                    ? this.$watch(i, function(t, e) {
                                          s.update.call(f, u, t, e, l);
                                      })
                                    : s.update.call(f, u, i, void 0, l)),
                            'function' == typeof p && (p = { destroy: p }),
                            p
                        );
                    }
                    return (
        ...
        function(t, e, n) {
            ...
            var i = n(5),
                a = n(15),
                o = i.extend(r.prototype, {
                    destroy: function(t) {
                        a.destroy(this.children, t),
        ...
        function(t, e, n) {
            ...
            function i(t, e) {
                f[h.END] &&
                    ((this.markStart = f[h.END]), (this.markEnd = h.END)),
                    (this.input = (t || '').trim()),
                    (this.opts = e || {}),
                    (this.map = 2 !== this.opts.mode ? s : u),
                    (this.states = ['INIT']),
                    e &&
                        e.expression &&
                        (this.states.push('JST'), (this.expression = !0));
            }
            function a(t) {
                for (var e, n, r = {}, i = 0, a = t.length; a > i; i++)
                    (e = t[i]),
                        (n = e[2] || 'INIT'),
                        (r[n] || (r[n] = { rules: [], links: [] })).rules.push(
                            e
                        );
                return o(r);
            }
            function o(t) {
                function e(t, e) {
                    return 'string' == typeof l[e]
                        ? c.escapeRegExp(l[e])
                        : String(l[e]).slice(1, -1);
                }
                var n, i, a, o, s, u, h;
                for (var f in t) {
                    (n = t[f]), (n.curIndex = 1), (i = n.rules), (a = []);
                    for (var p = 0, d = i.length; d > p; p++)
                        (h = i[p]),
                            (s = h[0]),
                            (o = h[1]),
                            'string' == typeof o && (o = r(o)),
                            'regexp' === c.typeOf(s) &&
                                (s = s.toString().slice(1, -1)),
                            (s = s.replace(/\{(\w+)\}/g, e)),
                            (u = c.findSubCapture(s) + 1),
                            n.links.push([n.curIndex, u, o]),
                            (n.curIndex += u),
                            a.push(s);
            ...
            (v.lex = function(t) {
                ...
                for (var s = 0; t; )
                    s++,
                        ...
                        (e = this.map[a]),
                        (n = e.TRUNK.exec(t)),
                        n || this.error('Unrecoginized Token'),
                        (r = n[0].length),
                        (t = t.slice(r)),
                        (i = this._process.call(this, n, e, t)),
                        i && o.push(i),
                        (this.index += r);
                ...
                (v._process = function(t, e, n) {
                    for (
                        var r, i = e.links, a = !1, o = i.length, s = 0;
                        o > s;
                        s++
                    ) {
                        var u = i[s],
                        ...
                        if (d(t[h])) {
                            (a = !0),
                                c &&
                                    ((r = c.apply(this, t.slice(h, h + u[1]))),
                                    r && (r.pos = this.index));
                            break;
                        }
                    }
                ...
                JST_LEAVE: [
                    ...
                    function(t) {
                        return this.markEnd === t && this.expression
                            ? { type: this.markEnd, value: this.markEnd }
                            : this.markEnd && this.marks
                                ? (this.marks--,
                                  { type: this.markEnd, value: this.markEnd })
        ...
        function(t, e, n) {
            ...
            var i = n(5),
                ...
                l = i.makePredicate(
                    'true false undefined null this Array Date JSON Math NaN RegExp decodeURI decodeURIComponent encodeURI encodeURIComponent parseFloat parseInt Object'
                ),
                p = r.prototype;
            (p.parse = function() {
                this.pos = 0;
                ...
                (p.error = function(t, e) {
                    throw ((t =
                        ...
                        i.trackErrorPos(
                            this.input,
                            'number' == typeof e ? e : this.ll().pos || 0
                        )),
                    new Error(t));
                }),
                (p.next = function(t) {
                ...
                (p.xml = function() {
                    ...
                    return (
                        ...
                        r ||
                            i.isVoidTag(t) ||
                            ((n = this.program()),
                            this.eat('TAG_CLOSE', t) ||
                                this.error(
                                    'expect </' + t + '> gotno matched closeTag'
                                )),
                        o.element(t, e, n)
                    );
                }),
                (p.xentity = function(t) {
                    ...
                    return (
                        'if' !== r &&
                            this.error(
                                'current version. ONLY RULE #if #else #elseif is valid in tag, the rule #' +
                                    r +
                                    ' is invalid'
                            ),
                        this['if'](!0)
                ...
                (p.directive = function() {
                    ...
                    return (
                        ...
                        'function' == typeof this[t]
                            ? this[t]()
                            : void this.error('Undefined directive[' + t + ']')
                    );
                }),
                ...
                (p['if'] = function(t) {
                    ...
                    return (
                        'if' !== u.value &&
                            this.error('Unmatched if directive'),
                        o['if'](e, n, r)
                    );
                }),
                (p.list = function() {
                ...
                (p.assign = function() {
                    ...
                    return (t = this.eat(['=', '+=', '-=', '*=', '/=', '%=']))
                        ? (e.set ||
                              this.error(
                                  'invalid lefthand expression in assignment expression'
                              ),
                          this.getset(
                              e.set
                                  .replace(
                ...
                (p.or = function() {
                    var t = this.and();
                    return this.eat('||')
                        ? this.getset(t.get + '||' + this.or().get)
                        : t;
                }),
                (p.and = function() {
                    var t = this.equal();
                    return this.eat('&&')
                        ? this.getset(t.get + '&&' + this.and().get)
                        : t;
                }),
                (p.equal = function() {
                    var t,
                        e = this.relation();
                    return (t = this.eat(['==', '!=', '===', '!==']))
                        ? this.getset(e.get + t.type + this.equal().get)
                        : e;
                }),
                (p.relation = function() {
                    var t,
                    ...
                    return (t =
                        this.eat(['<', '>', '>=', '<=']) ||
                        this.eat('IDENT', 'in'))
                        ? this.getset(e.get + t.value + this.relation().get)
                        : e;
                }),
                (p.additive = function() {
                    var t,
                        e = this.multive();
                    return (t = this.eat(['+', '-']))
                        ? this.getset(e.get + t.value + this.additive().get)
                        : e;
                }),
                (p.multive = function() {
                    var t,
                        e = this.range();
                    return (t = this.eat(['*', '/', '%']))
                        ? this.getset(e.get + t.type + this.multive().get)
                        : e;
                }),
                (p.range = function() {
                    var t,
                    ...
                    if ((t = this.eat('..'))) {
                        e = this.unary();
                        var r =
                            '(function(start,end){var res = [],step=end>start?1:-1; for(var i = start; end>start?i <= end: i>=end; i=i+step){res.push(i); } return res })(' +
                            n.get +
                            ',' +
                            e.get +
                            ')';
                ...
                (p.unary = function() {
                    var t;
                    return (t = this.eat(['+', '-', '~', '!']))
                        ? this.getset('(' + t.type + this.unary().get + ')')
                        : this.member();
                }),
                ...
                (p.arguments = function(t) {
                    t = t || ')';
                    var e = [];
                    do this.la() !== t && e.push(this.assign().get);
                    while (this.eat(','));
                    return e;
                }),
                (p.primary = function() {
                    ...
                    switch (t.type) {
                        ...
                        case 'IDENT':
                            return (
                                this.next(),
                                l(t.value) ? this.getset(t.value) : t.value
                            );
                        default:
                ...
                (p.object = function() {
                    for (
                        var t = [this.match('{').type],
                            e = this.eat(['STRING', 'IDENT', 'NUMBER']);
                        e;
        ...
        function(t, e, n) {
                ...
                u = {
                    events: function(t, e) {
                        var n = e._eventListeners || [],
                            r = a.normListener(t);
                        r.length && (e._eventListeners = n.concat(r)),
                            delete e.events;
                    },
                },
                c = ['data', 'computed'],
            ...
            t.exports = function f(t) {
                ...
                var r,
                    ...
                    s = (o && o.prototype) || {};
                return 'function' == typeof t
                    ? ((r = t.prototype), (t.implement = n), (t.extend = f), t)
                    : ((r = a.createProto(e, s)),
                      (e.implement = n),
                      e.implement(t),
                      o.__after__ && o.__after__.call(e, o, t),
                      (e.extend = f),
                      e);
            };
        },
        function(t, e, n) {
            var r = n(4),
                ...
                a = (t.exports = {
                    ...
                    last: function(t) {
                        var e = t.children;
                        return 'function' == typeof t.last
                            ? t.last()
                            : 'number' == typeof t.nodeType
                                ? t
                                : e && e.length
                                    ? a.last(e[e.length - 1])
                                    : t.group ? a.last(t.group) : void 0;
                    },
                    destroy: function(t, e) {
                        if (t) {
                            ...
                            if ('function' == typeof t.destroy)
                                return t.destroy(e);
                            'number' == typeof t.nodeType && e && r.remove(t),
                                o &&
                                    o.length &&
                                    (a.destroy(o, !0), (t.children = null));
                        }
                    },
                });
        ...
        function(t, e, n) {
                ...
                o = {
                    $on: function(t, e, n) {
                        if ('object' == typeof t && t)
                            for (var r in t) this.$on(r, t[r], e);
                        else {
                            n = n || {};
                            var i,
                                a = this,
                                o = a._handles || (a._handles = {}),
                                s = o[t] || (o[t] = []);
                            n.once &&
                                ((i = function() {
                        ...
                        if (n._handles) {
                            ...
                            if ((r = i[t])) {
                                ...
                                for (var a = 0, o = r.length; o > a; a++)
                                    if (e === r[a]) return r.splice(a, 1), n;
                            }
                            return n;
                        }
                    },
            ...
            a.extend(r.prototype, o),
                (r.mixTo = function(t) {
                    (t = 'function' == typeof t ? t.prototype : t),
                        a.extend(t, o);
                }),
                (t.exports = r);
        },
            ...
            var i = n(5),
                ...
                c = {
                    $watch: function(t, e, n) {
                        ...
                        var h = i.uid('w_');
                        if (Array.isArray(t)) {
                            for (var f = [], l = 0, p = t.length; p > l; l++)
                                f.push(this.$expression(t[l]).get);
                            var d = [];
                            s = function(t) {
                                for (
                                    var e = !0, n = 0, r = f.length;
                                    r > n;
                                    n++
                                ) {
                                    var a = f[n](t, c);
                        ...
                        if (
                            ...
                            (u = this._records && this._records.length),
                            u && this._records[u - 1].push(h),
                            n.init === !0)
                        ) {
                            var m = this.$phase;
                            (this.$phase = 'digest'),
                                this._checkSingleWatch(
                                    v,
                                    this._watchers.length - 1
                                ),
                                (this.$phase = m);
                        }
                        return v;
                                ...
                                n &&
                                    ...
                                    ((t.last =
                                        ...
                                        'array' === c
                                            ? i.clone(r)
                                            : r),
                                    t.fn.call(this, r, a, f),
                                    t.once && this._watchers.splice(e, 1)),
                                n
                            );
                        }
                    },
                    $set: function(t, e) {
                        if (null != t) {
                            var n = i.typeOf(t);
                            if ('string' === n || 'expression' === t.type)
                                (t = this.$expression(t)), t.set(this, e);
                            else if ('function' === n) t.call(this, this.data);
                            else for (var r in t) this.$set(r, t[r]);
                        }
                    },
                    $get: function(t, e) {
                        return e && 'string' == typeof t
                            ? t
                            : this.$expression(t).get(this);
                    },
                    $update: function() {
                        var t = this;
                        do {
        ...
        function(t) {
            ...
            (e.json = {
                ...
                (e.average = function(t, n) {
                    return (
                        (t = t || []), t.length ? e.total(t, n) / t.length : 0
                    );
                }),
                ...
                e(String.prototype, {
                    ...
                    e(Array.prototype, {
                        indexOf: function(t, e) {
                            e = e || 0;
                            for (var n = e, r = this.length; r > n; n++)
        ...
        function(t, e, n) {
            ...
            'ontransitionend' in window ||
                ('onwebkittransitionend' in window
                    ? ((c += ' webkitTransitionEnd'), (f = 'webkitTransition'))
                    : ('onotransitionend' in o.tNode ||
                          'Opera' === navigator.appName) &&
                      ((c += ' oTransitionEnd'), (f = 'oTransition'))),
                'onanimationend' in window ||
                    ('onwebkitanimationend' in window
                        ? ((h += ' webkitAnimationEnd'),
                          (l = 'webkitAnimation'))
                        : 'onoanimationend' in o.tNode &&
                          ((h += ' oAnimationEnd'), (l = 'oAnimation'))),
                (s.inject = function(t, e, n, r) {
                    if (((r = r || a.noop), Array.isArray(t))) {
                        for (
                            var i = o.fragment(), s = 0, u = 0, c = t.length;
                            c > u;
                            u++
                        )
                            i.appendChild(t[u]);
                ...
                return (!h && !c) || u.isRunning
                    ...
                    : ((p = a.once(
                      ...
                      2 === i
                          ? (o.addClass(t, e),
                            (s = a
                                .map(e.split(/\s+/), function(t) {
                                    return t + '-active';
                                })
                                .join(' ')),
                            o.nextReflow(function() {
                                o.addClass(t, s),
                                    (f = r(t)),
                                    (l = setTimeout(p, f));
                            }))
        ...
        function(t, e, n) {
            ...
            o._addProtoInheritCache('event'),
                o.directive(/^on-\w+$/, function(t, e, n, r) {
                    if (n && e) {
                        var i = n.split('-')[1];
                ...
                o.directive(/^(delegate|de)-\w+$/, function(t, e, n) {
                    ...
                    if (n && e) {
                        var c = n.split('-')[1],
                            h = i.handleEvent.call(this, e, c);
                        u[c] ||
                            ((u[c] = []),
                            s.parentNode
                                ? a.on(s.parentNode, c, o)
                                : s.$on('$inject', function(t, e, n) {
                                      var r = this.parentNode;
                                      n && a.off(n, c, o),
                                          r && a.on(this.parentNode, c, o);
                                  }),
                            s.$on('$destroy', function() {
                                s.parentNode && a.off(s.parentNode, c, o),
                                    (u[c] = null);
                            }));
        ...
        function(t, e, n) {
            function r(t, e) {
                ...
                return (
                    c.on(t, 'change', n),
                    void 0 === e.get(r) && t.value && e.set(r, t.value),
                    function() {
                        c.off(t, 'change', n);
                    }
                );
            ...
            function i(t, e, n) {
                var r,
                    ...
                    a = i.lazy;
                'throttle' in i &&
                    (r = i[r] === !0 ? 400 : parseInt(i.throttle, 10));
                var o = this,
                    h = this.$watch(e, function(e) {
                        t.value !== e && (t.value = null == e ? '' : '' + e);
                    }),
                    f = function(t) {
                        var n = this;
                        if ('cut' === t.type || 'paste' === t.type)
                            u.nextTick(function() {
                                var t = n.value;
                ...
                return (
                    ...
                    a
                        ...
                        : s
                            ...
                            : c.on(t, 'paste keyup cut change', f),
                    void 0 === e.get(o) && t.value && e.set(o, t.value),
                    function() {
                        return a
                            ? c.off(t, 'change', f)
                            : void (s
                                  ? t.removeEventListener('input', f)
                                  : c.off(t, 'paste keyup cut change', f));
                    }
                );
            }
            function a(t, e) {
                ...
                return (
                    e.set && c.on(t, 'change', i),
                    void 0 === e.get(n) && e.set(n, !!t.checked),
                    function() {
            ...
            function o(t, e) {
                ...
                return (
                    e.set && c.on(t, 'change', r),
                    void 0 === e.get(n) && t.checked && e.set(n, t.value),
                    function() {
            ...
            var s,
                ...
                c = n(4),
                h = n(3),
                f = { text: i, select: r, checkbox: a, radio: o };
            h.directive('r-model', {
                param: ['throttle', 'lazy'],
                link: function(t, e, n, r) {
                    ...
                    return (
                        'input' === a
                            ? (a = t.type || 'text')
                            : 'textarea' === a && (a = 'text'),
                        'string' == typeof e && (e = this.$expression(e)),
                        f[a]
                            ? f[a].call(this, t, e, r)
                            : 'input' === i
                                ? f.text.call(this, t, e, r)
                                : void 0
                    );
                },
            });
        ...
        function(t, e, n) {
            ...
            function a(t, e, n) {
                for (
                    var r = t.length, a = e.length, n = n || i, o = [], s = 0;
                    r >= s;
                    s++
                )
                    o.push([s]);
            ...
            function o(t, e, n, i) {
                ...
                c = 0;
                for (
                    var _ = [], T = { index: null, add: 0, removed: [] }, u = 0;
                    u < f.length;
                    u++
                )
                    switch ((f[u] > 0
                        ? null === T.index && (T.index = c)
                        : null != T.index &&
                          (_.push(T),
                          (T = { index: null, add: 0, removed: [] })),
                    f[u])) {
                        case g:
                            s++, c++;
                            break;
